...
import com.jecelyin.editor.v2.common.utils.LimitedQueue;
 ...
 */
public class EditAreaView extends TextView implements IEditAreaView {
    /**
    ...
    private static final String TAG = "EditAreaView";
    /**
...
//    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (DLog.DEBUG) DLog.d(TAG, "onTouchEvent() called with: ev = [" + ev + "]");
