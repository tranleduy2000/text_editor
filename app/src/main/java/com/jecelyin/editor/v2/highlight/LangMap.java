...
public class LangMap {
    public static int get(String filename) {
        switch (filename) {
            ...
            case "powercenter_parameter_file.xml":
                return R.raw.powercenter_parameter_file_lang;
            case "powerdynamo.xml":
